...
<form method="post" action="/kensakigus/deletedo">

<?= $this->Form->create($kensakigu, ['url' => ['action' => 'deletedo']]) ?>
<br><br><br>
...
<nav class="sample non-sample">
    ...
    <fieldset>
      ...
      <?= $this->Form->control('id', array('type'=>'hidden', 'value'=>$kensakigu['id'], 'label'=>false)) ?>
