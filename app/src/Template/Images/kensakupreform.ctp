...
<?= $this->Form->create($product, ['url' => ['action' => 'detail']]) ?>
<br><br><br>
...
<nav class="sample non-sample">
    ...
    <fieldset>
        <legend><strong style="font-size: 15pt; color:red"><?= __('検査表画像情報検索') ?></strong></legend>
        <br>
        <table>
          <tbody class='sample non-sample'>
          <tr class='sample non-sample'><td style="border:none"><strong style="font-size: 13pt"><?= __('検索するデータを入力してください') ?></strong></td></tr>
