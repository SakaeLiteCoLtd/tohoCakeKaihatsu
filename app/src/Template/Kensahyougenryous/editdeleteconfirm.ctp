...
<?= $this->Form->create($product, ['url' => ['action' => 'editdeletedo']]) ?>
<br> <br> <br>
...
<?php
 ...
 <br>
 <table class="top_big">
  <tr><td style="border:none"><strong style="font-size: 13pt; color:red"><?= __("以下のデータを削除します。よろしければ「決定」ボタンを押してください。") ?></strong></td></tr>
</table>
...
<table align="center">
  <tbody class='sample non-sample'>
    <tr>
      ...
      <td style="border:none"><?= $this->Form->submit(('決定'), array('name' => 'next')) ?></td>
    </tr>
  </tbody>
</table>
<br>
