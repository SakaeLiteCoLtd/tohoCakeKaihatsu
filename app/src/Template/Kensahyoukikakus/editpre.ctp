...
<br>
    <div align="center"><strong style="font-size: 13pt; color:red"><?= __("上の画像が現在使用されています。") ?></strong></div>
    <br>
<table align="center">
  <tbody class='sample non-sample'>
    <tr>
      ...
      <td style="border:none"><?= $this->Form->submit(('画像を変更する'), array('name' => 'change')) ?></td>
      <td style="border: none;"><?= __("　") ?></td>
      <td style="border:none"><?= $this->Form->submit(('画像を変更せずに次へ'), array('name' => 'nochange')) ?></td>
    </tr>
  </tbody>
</table>
<br>
