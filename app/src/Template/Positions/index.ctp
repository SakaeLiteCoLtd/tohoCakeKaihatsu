...
<a style="text-decoration: none" alien="center" href='/positions/addform' class="buttonlayout"/><font size='4' color=black><?= __('▷新規登録') ?></font></a>
</div>
        ...
        <tbody bgcolor="#FFFFCC">
            ...
            <tr>
              <td><?= h($i) ?></td>
                ...
                <td class="actions">
                  <?= $this->Html->link(__('編集'), ['action' => 'detail', $position->id]) ?>
                </td>
            </tr>
            <?php
            $i = $i + 1;
