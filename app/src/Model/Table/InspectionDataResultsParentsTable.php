...
/**
 * InspectionDataResultsParents Model
 *
 ...
 *
 * @method \App\Model\Entity\InspectionDataResultsParent get($primaryKey, $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\InspectionDataResultsParent findOrCreate($search, callable $callback = null, $options = [])
 */
class InspectionDataResultsParentsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('inspection_data_results_parents');
