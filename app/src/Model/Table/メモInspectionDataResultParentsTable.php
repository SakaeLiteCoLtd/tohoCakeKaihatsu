 ...
 *
 * @property |\Cake\ORM\Association\BelongsTo $InspectionStandardSizeParents
 * @property |\Cake\ORM\Association\BelongsTo $ProductConditonParents
...
//        $rules->add($rules->existsIn(['product_conditon_parent_id'], 'ProductConditonParents'));//ここをいれていたら登録できない（調べ中）
//https://absg.hatenablog.com/entry/2016/05/24/202932
