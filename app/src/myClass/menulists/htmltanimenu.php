...
class htmltanimenu extends AppController
{

     public function tanimenus()
  	{
        $html =
    ...
    //    "<nav class='large-3 medium-4 columns' id='actions-sidebar' style='width:20%;'>\n".
                      ...
                      "<br><br>\n".
                      "<font size='5'>　単位登録メニュー</font>\n".
                      "<br><br>\n".
                      "<font size='4'>　・</font><a href='/tanis/index' /><font size='4' color=black>単位一覧</font></a>\n".
