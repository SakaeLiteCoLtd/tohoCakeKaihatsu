...
class MaterialSuppliersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ryakusyou' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-06-16 12:02:00',
                'created_staff' => 1,
                'updated_at' => '2021-06-16 12:02:00',
                'updated_staff' => 1
            ],
        ];
        parent::init();
