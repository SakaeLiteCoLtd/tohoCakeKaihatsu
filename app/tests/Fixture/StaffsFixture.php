...
class StaffsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'occupation_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'sex' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'date_finish' => '2021-04-14',
                'delete_flag' => 1,
                'created_at' => '2021-04-14 11:18:31',
                'created_staff' => 1,
                'updated_at' => '2021-04-14 11:18:31',
                'updated_staff' => 1
            ],
        ];
        parent::init();
