...
/**
 * MachineRelaysFixture
 *
 */
class MachineRelaysFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'relay_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'bik' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'relay_code' => 'Lorem ipsum dolor sit amet',
                'name' => 'Lorem ipsum dolor sit amet',
                'bik' => 'Lorem ipsum dolor sit amet',
                'delete_flag' => 1,
                'created_at' => '2022-01-31 06:58:12',
                'updated_at' => '2022-01-31 06:58:12',
                'updated_staff' => 1
            ],
        ];
        parent::init();
