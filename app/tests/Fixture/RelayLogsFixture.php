 ...
 *
 */
class RelayLogsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'factory_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'machine_num' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'machine_relay_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'datetime' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'status' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '0=OFF,1=ON', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'machine_num' => 1,
                'machine_relay_id' => 1,
                'datetime' => '2022-01-31 06:57:31',
                'status' => 1,
                'delete_flag' => 1,
                'created_at' => '2022-01-31 06:57:31',
                'updated_at' => '2022-01-31 06:57:31',
                'updated_staff' => 1
            ],
        ];
        parent::init();
