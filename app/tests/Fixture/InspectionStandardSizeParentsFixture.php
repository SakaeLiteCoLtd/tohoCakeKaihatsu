...
/**
 * InspectionStandardSizeParentsFixture
 *
 */
class InspectionStandardSizeParentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_file_name_dir' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'inspection_standard_size_code' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'product_id' => 1,
                'image_file_name_dir' => 'Lorem ipsum dolor sit amet',
                'inspection_standard_size_code' => 'Lorem ipsum dolor sit amet',
                'version' => 1,
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-09-15 12:08:39',
                'created_staff' => 1,
                'updated_at' => '2021-09-15 12:08:39',
                'updated_staff' => 1
            ],
        ];
        parent::init();
