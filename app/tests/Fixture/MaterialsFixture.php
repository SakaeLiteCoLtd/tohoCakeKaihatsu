...
class MaterialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'grade' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'tanni_kosu' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'tanni_kosu' => 'Lorem ipsum dolor sit amet',
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-06-16 12:17:40',
                'created_staff' => 1,
                'updated_at' => '2021-06-16 12:17:40',
                'updated_staff' => 1
            ],
        ];
        parent::init();
