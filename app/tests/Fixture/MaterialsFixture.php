...
class MaterialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'maker' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-05-13 09:15:00',
                'created_staff' => 1,
                'updated_at' => '2021-05-13 09:15:00',
                'updated_staff' => 1
            ],
        ];
        parent::init();
