...
class MaterialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status_kensahyou' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '0=表示、1=非表示', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-10-08 16:25:31',
                'created_staff' => 1,
                'updated_at' => '2021-10-08 16:25:31',
                'updated_staff' => 1
            ],
        ];
        parent::init();
