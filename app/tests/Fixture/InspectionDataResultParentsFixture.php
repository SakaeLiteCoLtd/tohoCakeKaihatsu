...
class InspectionDataResultParentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'total_amount' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'created_at' => '2021-11-08 03:34:54',
                'created_staff' => 1,
                'updated_at' => '2021-11-08 03:34:54',
                'updated_staff' => 1
            ],
        ];
        parent::init();
