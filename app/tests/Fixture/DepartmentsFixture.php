...
class DepartmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'department' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'created_at' => '2021-04-14 11:17:12',
                'created_staff' => 1,
                'updated_at' => '2021-04-14 11:17:12',
                'updated_staff' => 1
            ],
        ];
        parent::init();
