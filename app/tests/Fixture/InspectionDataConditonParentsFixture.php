...
/**
 * InspectionDataConditonParentsFixture
 *
 */
class InspectionDataConditonParentsFixture extends TestFixture
{
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'datetime' => '2021-06-11 21:33:00',
                'delete_flag' => 1,
                'created_at' => '2021-06-11 21:33:00',
                'created_staff' => 1,
                'updated_at' => '2021-06-11 21:33:00',
                'updated_staff' => 1
            ],
        ];
        parent::init();
