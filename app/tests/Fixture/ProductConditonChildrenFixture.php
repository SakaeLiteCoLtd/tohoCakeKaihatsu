...
class ProductConditonChildrenFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'screw' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'screw' => 'Lorem ipsum dolor sit amet',
                'delete_flag' => 1,
                'created_at' => '2021-09-21 10:37:40',
                'created_staff' => 1,
                'updated_at' => '2021-09-21 10:37:40',
                'updated_staff' => 1
            ],
        ];
        parent::init();
