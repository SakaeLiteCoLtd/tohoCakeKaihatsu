...
/**
 * InspectionDataResultsParentsFixture
 *
 */
class InspectionDataResultsParentsFixture extends TestFixture
{
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'datetime' => '2021-06-14 14:08:53',
                'staff_id' => 1,
                'appearance' => 1,
                'result_weight' => 1,
                'judge' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-06-14 14:08:53',
                'created_staff' => 1,
                'updated_at' => '2021-06-14 14:08:53',
                'updated_staff' => 1
            ],
        ];
        parent::init();
