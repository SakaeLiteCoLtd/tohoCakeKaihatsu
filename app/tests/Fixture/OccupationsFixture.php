...
class OccupationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'occupation' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'delete_flag' => 1,
                'created_at' => '2021-04-14 11:17:31',
                'created_staff' => 1,
                'updated_at' => '2021-04-14 11:17:31',
                'updated_staff' => 1
            ],
        ];
        parent::init();
