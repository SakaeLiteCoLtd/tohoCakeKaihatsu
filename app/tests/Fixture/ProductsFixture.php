...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status_kensahyou' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-09-25 02:41:54',
                'created_staff' => 1,
                'updated_at' => '2021-09-25 02:41:54',
                'updated_staff' => 1
            ],
        ];
        parent::init();
