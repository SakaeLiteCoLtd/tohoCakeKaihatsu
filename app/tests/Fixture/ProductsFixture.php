...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'length_size' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '長さの規格サイズ'],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'is_active' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-09-16 14:12:33',
                'created_staff' => 1,
                'updated_at' => '2021-09-16 14:12:33',
                'updated_staff' => 1
            ],
        ];
        parent::init();
