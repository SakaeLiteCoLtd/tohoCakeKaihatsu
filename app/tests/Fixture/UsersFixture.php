...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_code' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'group_name_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_code' => 'Lorem ipsum dolor sit amet',
                'password' => 'Lorem ipsum dolor sit amet',
                'staff_id' => 1,
                'super_user' => 1,
                'group_name_id' => 1,
                'delete_flag' => 1,
                'created_at' => '2022-01-20 10:30:20',
                'created_staff' => 1,
                'updated_at' => '2022-01-20 10:30:20',
                'updated_staff' => 1
            ],
        ];
        parent::init();
