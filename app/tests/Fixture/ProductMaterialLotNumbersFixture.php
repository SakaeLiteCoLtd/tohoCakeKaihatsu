...
/**
 * ProductMaterialLotNumbersFixture
 *
 */
class ProductMaterialLotNumbersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_machine_material_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'datetme' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'lot_number' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'product_machine_material_id' => 1,
                'datetme' => '2021-05-01 17:36:41',
                'lot_number' => 'Lorem ipsum dolor sit amet',
                'staff_id' => 1,
                'delete_flag' => 1,
                'created_at' => '2021-05-01 17:36:41',
                'created_staff' => 1,
                'updated_at' => '2021-05-01 17:36:41',
                'updated_staff' => 1
            ],
        ];
        parent::init();
